...
for i, barcode in enumerate(barcodes):
    ...
    lines = [x.split('\t') for x in open('{0}sampleID_hlax_data_final.result.txt'.format(directory)).readlines()[:8]]
...
pickle.dump(dictionary, open('/cellar/users/ramarty/Data/hla_ii/hla_types/TCGA.HLA_classII._hlax_data.p', 'w'))