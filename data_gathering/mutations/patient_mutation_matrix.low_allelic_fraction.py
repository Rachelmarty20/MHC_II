...
samples_combined = pd.read_csv('/cellar/users/ramarty/Data/hla/mutations/processed_mutation_files.low_allelic_fraction.csv',
                               index_col=0)
...
matrix.to_csv('/cellar/users/ramarty/Data/hla_ii/presentation/patient_matrices/cancer.patient_mutation.low_allelic_fraction.csv')
