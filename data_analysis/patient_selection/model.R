...
pdf(paste('/cellar/users/ramarty/Data/hla_ii/generated_figures/', args[1], '/globalassoc_gam_harm.scatter.pdf', sep=''))
...
#
pdf(paste('/cellar/users/ramarty/Data/hla_ii/generated_figures/', args[1], '/globalassoc_gam_harm.model.pdf', sep=''))
...
pdf(paste('/cellar/users/ramarty/Data/hla_ii/generated_figures/',  args[1], '/globalassoc_descriptive.pdf', sep=''))
...
pdf(paste('/cellar/users/ramarty/Data/hla_ii/generated_figures/', args[1], '/oddsratio_withinpat_cancertype.pdf', sep=''))
...
pdf(paste('/cellar/users/ramarty/Data/hla_ii/generated_figures/', args[1], '/oddsratio_withingene_cancertype_100pat.pdf', sep=''))
x2plot <- tabgene[order(tabgene[,1]),]
...
pdf(paste('/cellar/users/ramarty/Data/hla_ii/generated_figures/', args[1], '/oddsratio_withinpat_cancertype_100pat.pdf', sep=''))
x2plot <- tabpat[order(tabpat[,1]),]
x2plot <- x2plot[rownames(x2plot) %in% names(npat[npat>=100]), ]
plot(x2plot[,1],1:nrow(x2plot),pch=15,xlim=c(0.25,4),yaxt='n',ylab='',xlab='Odds-ratio',log='x')
segments(x0=x2plot[,2],x1=x2plot[,3],1:nrow(x2plot),lty=2)
...
pdf(paste('/cellar/users/ramarty/Data/hla_ii/generated_figures/', args[1], '/oddsratio_withinpat_cancertype.20.pdf', sep=''))
x2plot <- tabpat[order(tabpat[,1]),]
plot(x2plot[,1],1:nrow(x2plot),pch=15,xlim=c(0.25,4),yaxt='n',ylab='',xlab='Odds-ratio',log='x')
segments(x0=x2plot[,2],x1=x2plot[,3],1:nrow(x2plot),lty=2)
text(x2plot[,2],1:nrow(x2plot),rownames(x2plot),pos=2)
...
pdf(paste('/cellar/users/ramarty/Data/hla_ii/generated_figures/', args[1], '/oddsratio_withingene_cancertype_100pat.20.pdf', sep=''))
x2plot <- tabgene[order(tabgene[,1]),]
x2plot <- x2plot[rownames(x2plot) %in% names(npat[npat>=100]), ]
plot(x2plot[,1],1:nrow(x2plot),pch=15,xlim=c(0.25,4),yaxt='n',ylab='',xlab='Odds-ratio',log='x')
segments(x0=x2plot[,2],x1=x2plot[,3],1:nrow(x2plot),lty=2)
...
pdf(paste('/cellar/users/ramarty/Data/hla_ii/generated_figures/', args[1], '/oddsratio_withinpat_cancertype_100pat.20.pdf', sep=''))
x2plot <- tabpat[order(tabpat[,1]),]
x2plot <- x2plot[rownames(x2plot) %in% names(npat[npat>=100]), ]
plot(x2plot[,1],1:nrow(x2plot),pch=15,xlim=c(0.25,4),yaxt='n',ylab='',xlab='Odds-ratio',log='x')
segments(x0=x2plot[,2],x1=x2plot[,3],1:nrow(x2plot),lty=2)
