...
write.table(results_dfII, file = paste("/cellar/users/ramarty/Data/hla_ii/generated_data/tissues/predictions.", tissue_type, ".MHC_I.", mutation_threshold, ".data.txt", sep=''))
...
results_df$predicted_prob<-exp(results_df$predicted)
results_df$label_fact <- factor(results_df$label)
write.table(results_dfII, file = paste("/cellar/users/ramarty/Data/hla_ii/generated_data/tissues/predictions.", tissue_type, ".MHC_II.", mutation_threshold, ".data.txt", sep=''))
...
results_df$predicted_prob<-exp(results_df$predicted)
results_df$label_fact <- factor(results_df$label)
write.table(results_dfII, file = paste("/cellar/users/ramarty/Data/hla_ii/generated_data/tissues/predictions.", tissue_type, ".Both.", mutation_threshold, ".data.txt", sep=''))
