...
write.table(auc_df, file = paste("/cellar/users/ramarty/Data/hla_ii/generated_data/predictions.mhc_ii.", args[1], '.', args[2], ".txt", sep=''))

# Plot the ROCs
pdf(paste('/cellar/users/ramarty/Data/hla_ii/generated_figures/predictions/ROC.mhc_ii.threshold_', args[1], '.', args[2], '.pdf', sep=''))
