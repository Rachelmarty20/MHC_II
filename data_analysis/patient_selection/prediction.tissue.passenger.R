...
mut <- read.csv(paste(PATH_TO_DATA, 'combined_classes/patient_mutations.passenger.csv', sep=""),header=TRUE)
aff1 <- read.csv(paste(PATH_TO_DATA, 'combined_classes/patient_affinities.passenger.class_i.csv', sep=""),header=TRUE)
